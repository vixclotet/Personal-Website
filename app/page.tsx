    ...
    <div className="flex flex-col items-center justify-center w-screen min-h-screen overflow-x-hidden overflow-y-auto bg-gradient-to-tl from-cyan-200 to-cyan-100">
      <nav className="my-16 animate-fade-in max-w-4xl mx-auto w-full px-4">
        <ul className="flex items-center justify-center gap-4">
          ...
          <img src="/public/favicon.png" alt="Center icon" className="w-16 h-16 mx-16"/>
          <Link
      ...
      <div className="my-16 text-center animate-fade-in max-w-4xl mx-auto w-full px-4">
        <h2 className="text-xl text-neutral-900 font-mono">
          Hi! I'm a 22 year old tech entrepreneur who loves to learn about emerging technologies and build cool things with smart people
        </h2>
      </div>
      <div className="my-16 text-center animate-fade-in max-w-4xl mx-auto w-full px-4 space-y-6">
        ...
        <h3 className="text-lg text-neutral-900 font-mono">
          ...
          I have a strong interest on the intersection between AI, Fintech, Content Creation, and SaaS business models. If you are interested and/or passionate about one of these areas, do not be scared to reach out to me!
        </h3>
      </div>
      <div className="my-16 text-center animate-fade-in max-w-4xl mx-auto w-full px-4">
        <h2 className="text-3xl text-neutral-900 font-mono font-bold">
